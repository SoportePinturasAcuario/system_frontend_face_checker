<template>
    <v-dialog v-model="dialog" persistent>
        <template v-slot:activator="{ props: activatorProps }">
            <v-btn v-bind="activatorProps" icon="gears" color="grey"></v-btn>
        </template>
        <v-card class="bg-primary">
            ...
            <template v-slot:title>
                <h2>Detalles de la instancia</h2>
            </template>
            ...
            <template v-slot:text>
                <v-card>
                    <v-tabs v-model="tab" color="black" bg-color="#E80852" align-tabs="center" stacked>
                        <v-tab value="1">
            ...
            <template v-slot:actions>
                <div style="width: 20%; margin: 0px auto;" class="mb-3">
                    <v-img src="/img/logo-pinturas-acuario-blanco.png"></v-img>
                </div>
            </template>
        </v-card>
    </v-dialog>
